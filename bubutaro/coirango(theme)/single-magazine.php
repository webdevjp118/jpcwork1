	...
	<div class="author-div">
		...
		<div class="photo-div">
			<div class="author-photo">
				<div class="c-circlediv" style="background-image:url('<?php echo $loop_authorphoto; ?>');">
				</div>
			</div>
...
<?php get_template_part( 'template-parts/content', get_post_type() ); ?>
	<div class="post-share">
		<p class="inner">
			<span class="c-roboto">SHARE ON</span><br class="csp">
			<a href="" class="fb-share-btn" target="_blank">シェア</a>
			<a href="" class="tw-share-btn" target="_blank">シェア</a>
		</p>
	</div>
	<div class="backbtn-div">
		<a href="<?php echo get_site_url(); ?>/magazines" class="back-btn">コイラン裏テクに戻る</a>
	</div>
