...
<div class="pg3">
    ...
    <div class="detail-sec">
        <div class="c-container">
            <ul class="submenu-ul">
                <li>
                    <a href="<?php echo get_site_url(); ?>/laundry/<?php echo $laundry_slug; ?>">みんなのお洗活</a>
                </li>
                <li>
                    <a href="">お気に入り</a>
                </li>
...
<?php 
    if($activity_query->have_posts()) : 
        while ($activity_query->have_posts()) : 
            ...
            $loop_photo = wp_get_attachment_image_src( get_post_thumbnail_id( $loop_id ), 'single-post-thumbnail' );
            $loop_photo = $loop_photo[0];
            $laundry_photo = wp_get_attachment_image_src( get_post_thumbnail_id( $laundry_id ), 'single-post-thumbnail' );
            $laundry_photo = $laundry_photo[0];
                ...
                <a href="<?php echo $activity_url; ?>"><div class="activity-div">
                    <div class="content-line">
                        ...
                        <div class="line-right">
                            ...
                            <div class="circlediv" style="background-url=('<?php echo $laundry_photo; ?>')";>
                            </div>
                        </div>
                    </div>
