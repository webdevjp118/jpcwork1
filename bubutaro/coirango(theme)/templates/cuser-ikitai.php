<?php /* Template Name: Cuser ikitai*/ ?>
<?php 
get_header(); 
...
<?php endif; ?>
		...
		<ul class="gsubmenu-ul">
            ...
            <li>
                <a data-icon="ikitai" class="selected" >Go!<?php echo_gmenuval($ikitai_count); ?></a>
            </li>
            <li>
...
<?php 
    if($ikitai_query->have_posts()) : 
        while ($ikitai_query->have_posts()) : 
            $ikitai_query->the_post(); 
...
?>
					<div class="js-button c-laundiv" data-href="<?php echo $loop_url; ?>">
						<div class="photo">
							<div class="c-rounddiv" style="background-image:url('<?php echo $loop_photo; ?>');"></div>
						</div>
