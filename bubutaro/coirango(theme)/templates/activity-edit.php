...
if(empty($laundry_id)) {
    wp_redirect(get_site_url().'/activities');
}
...
if( isset($_POST['action']) && $_POST['action'] == 'add_activity' ) { // Check what the post type is here instead
    ...
    if ($_POST['activity_date'] != '' ) { $activity_date =  parseDate($_POST['activity_date']); } else $activity_date = '';
...
<div class="c-formTextarea" style="margin-top: 8px;">
    <textarea id="activity_content" name="activity_content" maxlength="1200" cols="50" rows="30"><?php echo $activity_content; ?></textarea>
</div>
<div class="photo-line">
    <div class="photo-div">
        <div id="photo-preview" class="c-circlediv" style="background-image:url(<?php echo $activity_photo; ?>);">
        </div>
