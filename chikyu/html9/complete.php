...
// メール関連
define("EMAIL_SUBJECT", "件名:【地球人倶楽部】お試しパックのご注文ありがとうございます。");
...
define("SITE_DOMAIN", "chikyu-jin.com");
define("SITE_URL", $protocol."".SITE_DOMAIN);

// ホスト名により定数設定
switch ($hostname) {
// テスト用サーバ
case "chikyu-jin.work.com":
	// 開発環境
	define("IS_DEVELOPMENT", 0);
	// URL
	define("BASE_URL", $protocol."chikyu-jin.work.com");
	break;
// 本番用サーバ
case "www.chikyu-jin.com":
case "chikyu-jin.com":
default:
	// 開発環境
	define("IS_DEVELOPMENT", 0);
	// URL
	define("BASE_URL", $protocol."chikyu-jin.com");
	break;
}
...
function check_referer($url)
{
	...
	if (!isset($_SERVER["HTTP_REFERER"])) {
		header("Location: ./error.php"); //test
		exit();
	}
	if (is_array($url)) {
		$rval = 0;
...
$msg .= "生年月日"."： ".print_post_session("生年月日", 0, 1)."\n";
$msg .= "郵便番号"."： ".print_post_session_num(array("郵便番号", "郵便番号2"), 0, 1)."\n";
$msg .= "都道府県"."： ".print_post_session("都道府県", 0, 1)."\n";
$msg .= "市区町村"."： ".print_post_session("市区町村", 0, 1)."\n";
$msg .= "番地"."： ".print_post_session("番地", 0, 1)."\n";
$msg .= "マンション名等"."： ".print_post_session("マンション名等", 0, 1)."\n";
$msg .= "メールアドレス"."： ".print_post_session("メールアドレス", 0, 1)."\n";
$msg .= "電話番号"."： ".print_post_session_num(array("電話番号", "電話番号2", "電話番号3"), 0, 1)."\n";
$msg .= "ご希望の配達曜日"."： ".print_post_session("ご希望の配達曜日", 0, 1)."\n";
...
$subject = "件名:【地球人倶楽部】お試しパックのご注文ありがとうございます。";
// メール本文作成
$body .= $subject;
$body .= "\n";
$body .= "\n";
$body .= "（".print_post_session("お名前", 0, 1)." ".print_post_session("お名前・名", 0, 1)."）様";
$body .= "\n";
$body .= "\n";
$body .= "地球人倶楽部でございます。お世話になっております。"."\n";
$body .= "この度はお試しパックのご注文ありがとうございます。"."\n";
$body .= "下記内容で承りました。ご確認下さいませ。"."\n";
$body .= "\n";
$body .= $msg;
$body .= "\n";
$body .= "\n";
$body .= "■お届けの日程について" . "\n";
$body .= "お申し込みいただいて1日から2日程度いただき、" . "\n";
$body .= "お届けする日程を調整のうえ、ご連絡申し上げます。" . "\n";
$body .= "少々お待ち下さいませ。" . "\n";
$body .= "\n";
$body .= "※土曜、日曜日にお申し込みいただきました場合のお返事は、" . "\n";
$body .= "明け、月曜日となります。" . "\n";
$body .= "\n";
$body .= "ご不明な点がございましたら、何なりとお申し付け下さいませ。" . "\n";
$body .= "\n";
$body .= $mail_signature . "\n";
$body .= "\n";
$headers = 'From: ' . $from . "\r\n" .
...
<main class="pg2">
	...
	<section class="inner">
		<div class="contactCotainer">
			...
			<p class="message">ご申し込みありがとうございます。<br>
			ご入力いただいたメールアドレスに、内容確認メールをお送りしました。<br>
			あらためてご連絡差し上げますので、今しばらくお待ちください。</p>
			<div class="topBtn"><a href="./trial.php">&raquo;&nbsp;トップページに戻る</a></div>
		</div><!-- /contactCotainer -->
	</section><!-- /inner -->
</main>
	...
	<div class="window_info">
      ...
      <a href="http://.contact .contactCotainer .message/">chikyu-jin.com</a>
      </p>
  </div>
