...
$(function() {
	...
	$('#show_profile1').on('click', function(){
		$('#show_profile1').css('display','none');
		$('#profile_detail1').css('display','block');
		$('#interview_detail1').css('display','block');
	});
	$('#show_profile2').on('click', function(){
		$('#show_profile2').css('display','none');
		$('#profile_detail2').css('display','block');
		$('#interview_detail2').css('display','block');
	});
	/*---------------------------------------------------
		共通
	---------------------------------------------------*/
