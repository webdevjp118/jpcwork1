<?php /* Smarty version 2.6.22, created on 2021-06-18 17:45:25
         compiled from news.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'news.html', 108, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<?php if ($this->_tpl_vars['admin']['auth5']['1']): ?>
...
<th>公開・非公開</th>
<th>参照</th>
<?php if ($this->_tpl_vars['admin']['auth5']['2']): ?>
<th>編集</th>
<?php endif; ?>
<?php if ($this->_tpl_vars['admin']['auth5']['3']): ?>
<th>削除</th>
<?php endif; ?>
</tr>
</thead>
...
?>
<tr>
<td><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['news_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y/%m/%d") : smarty_modifier_date_format($_tmp, "%Y/%m/%d")); ?>
</td>
...
<?php if ($this->_tpl_vars['item']['kind_v'] == 1): ?>
<td><a href="../news/<?php echo $this->_tpl_vars['item']['seq']; ?>
" target="_blank" class="btn btn-block btn-default btn-xs"><i class="fa fa-external-link"></i> 参照</a></td>
<?php else: ?>
<td><a href="../event/<?php echo $this->_tpl_vars['item']['seq']; ?>
" target="_blank" class="btn btn-block btn-default btn-xs"><i class="fa fa-external-link"></i> 参照</a></td>
<?php endif; ?>
<?php if ($this->_tpl_vars['admin']['auth5']['2']): ?>
<td>
<a href="news-edit.html&id=<?php echo $this->_tpl_vars['item']['seq']; ?>
