<?php /* Smarty version 2.6.22, created on 2021-06-18 17:47:30
         compiled from admin-item-edit-thankyou.html */ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<p>求人情報の、登録・編集が完了しました。</p>
</div>
<?php if ($this->_tpl_vars['last_query']): ?>
<div class="text-center">
<p><a href="./?<?php echo $this->_tpl_vars['last_query']; ?>
" class="btn btn-default">一覧に戻る</a></p>
</div>
<?php else: ?>
<div class="text-center">
<p><a href="admin-item.html" class="btn btn-default">一覧に戻る</a></p>
</div>
<?php endif; ?>
</div><!-- /.box-body -->
</div><!-- /.box -->
