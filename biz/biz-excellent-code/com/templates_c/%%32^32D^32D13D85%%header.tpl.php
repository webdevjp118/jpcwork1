<?php /* Smarty version 2.6.22, created on 2018-05-15 13:47:41
	...
	<div id="header">
		...
		<div class="fr">
			...
			<div class="hello_01">
				<p class="">ようこそ&nbsp;<?php echo $this->_tpl_vars['admin']['name']; ?>
&nbsp;さん</p>
	...
	<!--グローバル開始-->
		<ul class="global">
			...
			<?php if (! $this->_tpl_vars['admin']['auth3']['1'] && ! $this->_tpl_vars['admin']['auth3']['2'] && ! $this->_tpl_vars['admin']['auth3']['3']): ?>
			<?php else: ?>
			...
			<?php if (! $this->_tpl_vars['admin']['auth7']['1'] && ! $this->_tpl_vars['admin']['auth7']['2'] && ! $this->_tpl_vars['admin']['auth7']['3']): ?>
			<?php else: ?>
