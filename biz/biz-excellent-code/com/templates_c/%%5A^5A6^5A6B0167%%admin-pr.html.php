<?php /* Smarty version 2.6.22, created on 2017-10-16 14:33:59
         compiled from admin-pr.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin-pr.html', 112, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<?php if ($this->_tpl_vars['admin']['auth7']['1']): ?>
<a href="admin-pr-edit.html" class="btn btn-warning"><i class="fa fa-plus-square"></i> 新規作成</a>
<?php endif; ?>
</div>
...
<th>参照</th>
-->
<?php if ($this->_tpl_vars['admin']['auth7']['2']): ?>
<th>編集</th>
<?php endif; ?>
<?php if ($this->_tpl_vars['admin']['auth7']['3']): ?>
<th>削除</th>
<?php endif; ?>
</tr>
</thead>
...
?>
<tr>
<td><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['pr_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y/%m/%d") : smarty_modifier_date_format($_tmp, "%Y/%m/%d")); ?>
</td>
<td class="tac w250">
...
<!--
<td><a href="#" class="btn btn-block btn-default btn-xs"><i class="fa fa-external-link"></i> 参照</a></td>
-->
<?php if ($this->_tpl_vars['admin']['auth7']['2']): ?>
<td>
<a href="admin-pr-edit.html&id=<?php echo $this->_tpl_vars['item']['seq']; ?>
...
function do_delete(id)
{
	if (confirm(\'削除しても良いですか？\')) {
		location = \'./admin-pr.html&mode=delete&id=\' + id;
	}
}
...
//	document.form1.submit();
	document.location = \'admin-pr.html&page=\' + page;
}
</script>
'; ?>
