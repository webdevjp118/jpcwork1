...
?>
                            <div class="pagination-hp">
                                <a href="<?php echo $finalurl; ?>/page/<?php echo $prev_paged; ?>" class="pagination-item-hp"><i class='fas fa-chevron-left'></i></a>
<?php 
for($i=1;$i<=$total_pages;$i++) {
	if($i == $paged) {
		echo '<a href="'.$finalurl.'/page/'.$i.'" class="pagination-item-hp active">'.$i.'</a>';
	}
	else {
		echo '<a href="'.$finalurl.'/page/'.$i.'" class="pagination-item-hp">'.$i.'</a>';
	}
}
?>
                                <a href="<?php echo $finalurl; ?>/page/<?php echo $next_paged; ?>" class="pagination-item-hp"><i class='fas fa-chevron-right'></i></a>
                            </div>
                        </div>
