            ...
            <div class="media_list_inner">
                <div class="media_list_details">
                        ...
                        <div class="media_list_details_image_text">
                            ...
                            <div class="media_list_details_text <?php echo $loop_category_eng; ?>">
                                ...
                                <div class="media_details_title">
                                    <div class="kenkattu_title"><span><?php echo $loop_category_desc; ?></span><h1><?php echo $loop_title; ?></h1></div>
                                </div>
                    ...
                    <div class="media_list_details_contents">
                        ...
                        <h5>ケンカツ状況（期間、頻度、回数など）</h5>
                        <p><?php echo $loop_ken_duration; ?></p>
                        <h5>健康</h5>
                        <div class="pmhwp">
                            <?php echo wpautop($loop_content_health); ?>
                            <div style="clear:both"></div>
                        </div>
                        <h5>環境</h5>
                        <div class="pmhwp">
                            <?php echo wpautop($loop_content_env); ?>
                            <div style="clear:both"></div>
                        </div>
                    </div>
                    <div class="media_list_details_comment">
                        ...
                        <div class="pmhwp">
                            <?php echo wpautop($loop_ken_comment); ?>
                            <div style="clear:both"></div>
                        </div>
                    </div>
                    <div class="media_list_details_reference">
                        ...
                        <?php if(!empty($loop_buy_url)): ?>
                            <a href="<?php echo $loop_buy_url; ?>" id="id_kenkattu_buy_btn" class="blue_btn buyurl">ケンカツアイテム購⼊はこちら</a>
                        <?php else: ?>
                            <a href="javascript:void(0)" id="id_kenkattu_buy_btn" class="blue_btn buyurl_disabled">ケンカツアイテム購⼊はこちら</a><br>
                        <?php endif; ?>
                    </div>
