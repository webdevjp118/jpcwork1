  ...
  <nav id="pcnav">
    <ul id="headernav">
      ...
      <li<?php if($current == 1) echo ' class="current"'; ?>><a href="/picosure-tattoo/"><span class="jp">タトゥー・刺青除去(ピコシュア)TOP</span></a></li>
      <li<?php if($current == 2) echo ' class="current"'; ?>><a href="/beforeafter-category/%e3%82%bf%e3%83%88%e3%82%a5%e3%83%bc%e9%99%a4%e5%8e%bb/"><span class="jp">症例写真</span></a></li>
    </ul>
    <ul id="fixedsns">
