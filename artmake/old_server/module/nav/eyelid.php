  ...
  <nav id="pcnav">
    <ul id="headernav">
      ...
      <li<?php if($current == 1) echo ' class="current"'; ?>><a href="/eyelid/"><span class="jp">二重まぶた術 TOP</span></a></li>
      <li<?php if($current == 2) echo ' class="current"'; ?>><a href="/eyelid/burial/"><span class="jp">埋没法</span></a></li>
      <li<?php if($current == 3) echo ' class="current"'; ?>><a href="/eyelid/megashira/"><span class="jp">目頭切開法</span></a></li>
      <li<?php if($current == 4) echo ' class="current"'; ?>><a href="/eyelid/minisekkai/"><span class="jp">小切開法</span></a></li>
      <li<?php if($current == 5) echo ' class="current"'; ?>><a href="/eyelid/sekkai/"><span class="jp">全切開法</span></a></li>
      <li<?php if($current == 6) echo ' class="current"'; ?>><a href="/beforeafter-category/%e4%ba%8c%e9%87%8d/"><span class="jp">症例写真</span></a></li>
    </ul>
    <ul id="fixedsns">
