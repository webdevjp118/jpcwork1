  ...
  <nav id="pcnav">
    <ul id="headernav">
      ...
      <li<?php if($current == 1) echo ' class="current"'; ?>><a href="/depilate/"><span class="jp">脱毛TOP</span></a></li>
      <li<?php if($current == 2) echo ' class="current"'; ?>><a href="/depilate/process/"><span class="jp">医療レーザー脱毛とは</span></a></li>
      <li<?php if($current == 3) echo ' class="current"'; ?>><a href="/depilate/flow/"><span class="jp">施術の流れ</span></a></li>
      <li<?php if($current == 4) echo ' class="current"'; ?>><a href="/depilate/price/"><span class="jp">料金</span></a></li>
      <li<?php if($current == 5) echo ' class="current"'; ?>><a href="/depilate/attention/"><span class="jp">注意事項</span></a></li>
      <li<?php if($current == 6) echo ' class="current"'; ?>><a href="/depilate/faq/"><span class="jp">FAQ</span></a></li>
    </ul>
    <ul id="fixedsns">
