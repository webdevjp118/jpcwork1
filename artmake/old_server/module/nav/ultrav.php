  ...
  <nav id="pcnav">
    <ul id="headernav">
      ...
      <li<?php if($current == 1) echo ' class="current"'; ?>><a href="/ultrav/"><span class="jp">ウルトラVリフト TOP</span></a></li>
      <li<?php if($current == 2) echo ' class="current"'; ?>><a href="/ultrav/effect/"><span class="jp">効果</span></a></li>
      <li<?php if($current == 3) echo ' class="current"'; ?>><a href="/ultrav/feature/"><span class="jp">特徴</span></a></li>
      <li<?php if($current == 4) echo ' class="current"'; ?>><a href="/ultrav/flow/"><span class="jp">施術の流れ</span></a></li>
      <li<?php if($current == 5) echo ' class="current"'; ?>><a href="/ultrav/attention/"><span class="jp">注意事項</span></a></li>
      <li<?php if($current == 6) echo ' class="current"'; ?>><a href="/ultrav/faq/"><span class="jp">FAQ</span></a></li>
    </ul>
    <ul id="fixedsns">
