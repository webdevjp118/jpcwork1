  ...
  <nav id="pcnav">
    <ul id="headernav">
      ...
      <li<?php if($current == 1) echo ' class="current"'; ?>><a href="/injection/"><span class="jp">注射・点滴 TOP</span></a></li>
      <li<?php if($current == 2) echo ' class="current"'; ?>><a href="/injection/menu/"><span class="jp">メニューの種類</span></a></li>
      <li<?php if($current == 3) echo ' class="current"'; ?>><a href="/injection/faq/"><span class="jp">よくある質問</span></a></li>
    </ul>
    <ul id="fixedsns">
