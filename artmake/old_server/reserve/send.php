...
//送信内容
$cnsl = htmlspecialchars($_POST["cnsl"]);
$cnsl_etc = htmlspecialchars($_POST["cnsl_etc"]);
...
//題
$sSubject     = '【KMクリニック】ご予約フォームからの送信｜本サイト';
//ヘッダー
//$sHeaders     = 'From:'.$name.'<'.$email.'>';
$sHeaders     = 'From:'. mb_encode_mimeheader($name) . '<'.$email.'>';

//本文
$sMessage .= 

"------------------------------------------------------------
このメールは（http://www.kmshinjuku.com/reserve/）から送信されています。
------------------------------------------------------------
